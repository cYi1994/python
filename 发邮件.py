...
my_sender = 'chuan.yi@lejent.com'  # 发件人邮箱账号，为了后面易于维护，所以写成了变量
my_user = 'chuan.yi@lejent.com'  # 收件人邮箱账号，为了后面易于维护，所以写成了变量


def mail():
    ret = True
    try:
        msg = MIMEText('hello my bro', 'plain', 'utf-8')
        ...
        server.login(my_sender, "Malilan123")  # 括号中对应的是发件人邮箱账号、邮箱密码
